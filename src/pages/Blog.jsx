          ...
          <div className="row m-4 gy-3">
            ...
            <div className="col-md-4">
              <div className="card">
                <div className="card-header">
                  <img
                    src="img/market-4856748_640.jpg"
            ...
            <div className="col-md-4">
              <div className="card">
                <div className="card-header">
                  <img
                    src="img/magnifying-glass-76520_640.png"
                    className="card-img-top mx-auto d-bloc mt-3"
          ...
          <div className="row m-4 gy-3">
            <div className="col-md-4">
              <div className="card">
                <div className="card-header">
                  <img
                    src="img/computer-1231889_640.jpg"
                    className="card-img-top mx-auto d-bloc mt-3"
            ...
            <div className="col-md-4">
              <div className="card">
                <div className="card-header">
                  <img
                    src="img/search-engine-optimization-1359430_640.png"
                    className="card-img-top mx-auto d-bloc mt-3"
